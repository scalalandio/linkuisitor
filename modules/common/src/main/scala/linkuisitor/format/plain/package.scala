...
import linkuisitor.{ FlatLinkDetails, GroupedLinkDetails, LinkDetails, Linked }
...
package object plain {
  ...
  implicit def linkedEncoder[T: Encoder]: Encoder[Linked[T]] = (linked: Linked[T]) => Json.obj(
